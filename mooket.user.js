...
// @version      20250419.1.5
// @description  银河奶牛历史价格（包含强化物品）history market data for milkywayidle
// @author       IOMisaka
...
(function () {
  ...
  class CoreMarket {
      ...
      async getItemPriceAsync(itemHridOrName, enhancementLevel = 0) {
          ...
          let priceObj = new Price(resObj.bid, resObj.ask, resObj.time);
  ...
  function mooket() {
      ...
      addEventListener("MWICoreItemPriceUpdated", () => {
          ...
          itemUpdateTimer = setTimeout(updateInventoryStatus, 1000);
      });
